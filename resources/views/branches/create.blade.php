    ...
    <div class="p-6">
        <div class="max-w-xl">
            ...
            <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <form method="POST" action="{{ route('branches.store') }}" class="divide-y divide-gray-100 dark:divide-gray-700">
                    @csrf
                    ...
                    <div class="flex items-center justify-end gap-3 px-6 py-4">
                        ...
                        <button
                            type="submit"
                            class="inline-flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900">
